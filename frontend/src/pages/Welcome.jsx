...
const Welcome = () => {
  ...
  const handleContinue = () => {
    ...
    setTimeout(() => {
      navigate(currentRole === 'developer' ? '/my-projects' : '/projects', { replace: true });
    }, 500);
  };
              ...
              <HStack spacing={8} justify="center">
                ...
                >
                  <Button
                    ...
                    leftIcon={currentRole === 'developer' ? <FaCode /> : <FaSearch />}
                    _hover={{
                    ...
                    fontSize="xl"
                  >
                    {currentRole === 'developer' ? 'Go to My Projects' : 'Browse Projects'}
                  </Button>
                </MotionBox>
